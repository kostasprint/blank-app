...
# Column 1
with col1:
    model1 = st.selectbox("Select a model", ("openai/gpt-4o-mini-2024-07-18", "Claude 3.5 Sonnet"), key="model1")
    prompt1 = st.text_area("Enter your prompt:", height=200)

# Column 2
with col2:
    model2 = st.selectbox("Select a model", ("Mistral Large"), key="model2")
    prompt2 = st.text_area("Enter your prompt:", height=200)
